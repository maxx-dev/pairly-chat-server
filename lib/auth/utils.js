// https://github.com/zhouyuexie/learn-webauthn/tree/2a96723ee1709478a1aaaccf95a9561d1de01953
...
let verifyAuthenticatorAttestationResponse = (webAuthnResponse) => {
  ...
  console.log(publicKey)
  console.log('method',ctapMakeCredResp.fmt);*/
  ...
  } else if (ctapMakeCredResp.fmt === 'android-safetynet') { // Android fingerprint
    response.verified = verifyAndroidSafetynetWebauthn(webAuthnResponse)
  } else if (ctapMakeCredResp.fmt === 'none')
  {
    response.verified = true;
  } else if (ctapMakeCredResp.fmt === 'apple') { // new in ios 14 beta 6
    response.verified = true;
  }
